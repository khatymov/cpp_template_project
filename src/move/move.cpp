...
Move::Move(Move&& other) noexcept
    : _str_ptr(std::exchange(other._str_ptr, nullptr)), _str(std::move(other._str)) {
...
std::string Move::get_str() const { return this->_str; }

const char* Move::get_str_prt() const { return this->_str_ptr; }
